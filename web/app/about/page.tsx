  ...
  return (
    <div>
      ...
      <p>
        ...
        consequence-aware work where a wrong call has real cost. The habit of methodical
        debugging and ownership carried directly into software. I started in cloud
        application work and kept learning and working down the stack. From services, 
        to the data moving through them, to the inference engines serving models.
      </p>
      ...
      <p>
        ...
        data, or ML-systems work, I&apos;d love to talk, please feel free to <a href="/contact">reach out</a>.
      </p>
      </div>
    </div>
  );
